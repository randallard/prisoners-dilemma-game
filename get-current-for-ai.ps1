...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/api-error.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/connection-api.service.ts"
