...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/components/connection/connection-status-indicator.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/components/connection/connection-updates-manager.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/components/connection/websocket-connection-manager.ts"
...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/models/connection-data.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/models/connection-status.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/api/api-error.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/api/connection-api-service.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/api/connection-data-mapper.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/utils/result.ts"
...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/services/uuid-utils.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/src/utils/game-logic.ts"
...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/components/connection-status-indicator.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/components/connection-updates-manager.test.ts"
...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/components/websocket-connection-manager.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/unit/services/api-error.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/unit/services/connection-api-service.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/unit/services/connection-data-mapper.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/unit/services/connection-service.api.test.ts"
...
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/unit/utils/game-logic.test.ts"
Copy-ToAIChatFiles -SourcePath "prisoners-dilemma-app/test/setup.ts"
